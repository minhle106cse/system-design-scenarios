...
> Last updated: 2026-08-21T09:03:59.160359+00:00
> 
...
Key sections:- SOP: Naming Conventions  - 1. Repository (Domain interface + Infrastructure impl)  - 2. Command/Query Handler (CQRS)  - 3. Domain Error class  - 4. NestJS Module (`@Module`)  - 5. Config env var  - 6. Domain Service (pure logic, class not functions)  - 7. Application Service (application-layer orchestration with no CommandBus/QueryBus)  - 8. `presentation/` controller sub-folder — always nested under `controllers/`  - ⚠️ How to apply this file
...
> **Not inlined here — see `.ai/GOTCHAS.md`** (32 entries, newest first).
