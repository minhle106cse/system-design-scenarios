...
> Last updated: 2026-08-11T10:11:54.642634+00:00
> 
...
Key sections:- SOP: Naming Conventions  - 1. Repository (Domain interface + Infrastructure impl)  - 2. Command/Query Handler (CQRS)  - 3. Domain Error class  - 4. NestJS Module (`@Module`)  - 5. Config env var  - 6. Domain Service (pure logic, class not functions)  - ⚠️ How to apply this file
...
> **Not inlined here — see `.ai/GOTCHAS.md`** (31 entries, newest first).
