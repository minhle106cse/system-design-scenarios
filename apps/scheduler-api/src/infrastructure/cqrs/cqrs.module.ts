 ...
 * in the wrong order (docs/adr/0001-transaction-retry-boundary.md §2.3).
 ...
 * handlers: a single-database booking is one transaction, not a saga. The
 * saga interfaces stay in shared-kernel's public surface regardless (see
 * .ai/plans/init-source.plan.md §3.1) so the bus's compensation contract is available the
