...
describe('makePrismaTransientErrorHelpers', () => {
  ...
  describe('recordObservation', () => {
    ...
    it('counts a domain error marked transient:true under code="A2001" — regression: isTransient retried it while recordObservation stayed silent (ADR-0005 §9d)', async () => {
